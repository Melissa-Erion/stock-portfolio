    ...
    render() {
      ...
      return (
        <div className="container mx-auto">
          <h1 className="text-center my-4" id="title">Stock Portfolio</h1>
          <div className="row justify-content-center">
            ...
            <form className="col-12 mt-2 mb-4 d-flex" onSubmit={this.addStock}>
              <input
                className="mx-2 y-name"
                name="name"
                type="text"
                placeholder="Name"
            ...
            <div className="col-12 col-md-6">
              <h4 className="mb-3 pl-5">Portfolio value: $ {portfolio_market_value}</h4>
            </div>
            <div className="col-12 col-md-6">
